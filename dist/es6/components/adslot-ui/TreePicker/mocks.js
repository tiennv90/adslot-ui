...
var svgSymbol = { href: '/assets/svg-symbols#search' };
...
var rootTypes = [{
  ...
  isRequired: true
}, { label: 'Audiences', id: 'b', svgSymbol: svgSymbol, isRequired: false }, { label: 'Segments', id: 'c', svgSymbol: svgSymbol, isRequired: true }, {
...
var auPath = { id: 'au', label: 'AU', path: [] };
var actPath = { id: 'au-act', label: 'ACT', path: [auPath] };
