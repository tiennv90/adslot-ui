...
var teamMember1 = { givenName: 'John', id: 1, surname: 'Smith' };

var teamMember2 = { givenName: 'Jane', id: 2, surname: 'Doe' };

var teamMember3 = { givenName: 'Jack', id: 3, surname: 'White' };
...
var userHeaders = { label: 'Team', toggle: 'Member' };
